...
def plot_spectrogram_with_formants(audio_file, formants, formant_labels, subplot_num):
...
plot_spectrogram_with_formants(audio_file_path_a, formant_a, formant_labels, 511)
...
plot_spectrogram_with_formants(audio_file_path_e, formant_e, formant_labels, 512)
...
plot_spectrogram_with_formants(audio_file_path_i, formant_i, formant_labels, 513)
...
plot_spectrogram_with_formants(audio_file_path_o, formant_o, formant_labels, 514)
...
plot_spectrogram_with_formants(audio_file_path_u, formant_u, formant_labels, 515)
